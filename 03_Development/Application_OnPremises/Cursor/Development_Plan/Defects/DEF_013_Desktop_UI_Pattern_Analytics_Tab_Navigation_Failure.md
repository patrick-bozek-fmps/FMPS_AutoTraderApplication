...
### **Acceptance Criteria**
- [ ] Pattern Analytics tab can be navigated to without errors
- [ ] PatternAnalyticsView displays correctly with all components
- [ ] Pattern list, filters, and detail analytics are visible and functional
